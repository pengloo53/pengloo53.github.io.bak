...
参考此处：[CentOS8 安装 Docker-阿里云开发者社区](https://developer.aliyun.com/article/753261?accounttraceid=778f786f99dc4a1689b886735dbdb33bfmei)
...
# -t 指定 image 文件名称，可指定标签，最后指定 Dockerfile 的路径
...
注意：发布镜像需要在 [hub.docker.com](https://hub.docker.com/) 上注册账号，另外，尽量使用别人制作的 image 文件，多从[官方仓库]([Docker Hub Container Image Library | App Containerization](https://hub.docker.com/))看看。
